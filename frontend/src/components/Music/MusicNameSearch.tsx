...
import { setName } from "../../stores/Slice/musicSlice";
...
interface MusicNameSearchProps {
  searchData: () => void; // Expect a function with no arguments
}

const MusicNameSearch: React.FC<MusicNameSearchProps> = ({ searchData }) => {
  const dispatch = useDispatch<AppDispatch>();
  const { name } = useSelector((state: RootState) => state.music.data);
...
export default MusicNameSearch;
